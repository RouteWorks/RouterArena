...
class CostModel:
    ...
    def estimate(self, model_name: str, input_tokens: int, output_budget: int) -> float:
        ...
        """
        input_price_per_million = self.pricing[model_name]["input_token_price_per_million"]
        output_price_per_million = self.pricing[model_name]["output_token_price_per_million"]

        cost = (input_tokens * input_price_per_million / 1000000) + (output_budget * output_price_per_million / 1000000)
